...
import 'package:supermarket_list/utils/QuantityFormatter.dart';
...
class _ItemEditPageState extends State<ItemEditPage> {
  ...
  //final _cImage = TextEditingController();
  ...
  void initState() {
    ...
    //_cImage.text = ItemEditPage.item['imagem'];
  ...
  Widget build(BuildContext context) {
    ...
    /*final inputImage = TextFormField(
      controller: _cImage,
      autofocus: true,
      decoration: InputDecoration(
